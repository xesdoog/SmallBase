...
eVehicleDrivingFlags = {
    ...
    STOP_FOR_VEHICLES                            = 1,
    STOP_FOR_PEDS                                = 2,
    SWERVE_AROUND_ALL_VEHICLES                   = 3,
    STEER_AROUND_STATIONARY_VEHICLES             = 4,
    STEER_AROUND_PEDS                            = 5,
    STEER_AROUND_OBJECTS                         = 6,
    DONT_STEER_AROUND_PLAYER_PED                 = 7,
    STOP_AT_TRAFFIC_LIGHTS                       = 8,
    GO_OFF_ROAD_WHEN_AVOIDING                    = 9,
    ALLOW_GOING_WRONG_WAY                        = 10,
    REVERSE                                      = 11,
    USE_WANDER_FALLBACK_INSTEAD_OF_STRAIGHT_LINE = 12,
    AVOID_RESTRICTED_AREAS                       = 13,
    PREVENT_BACKGROUND_PATHFINDING               = 14,
    ADJUST_CRUISE_SPEED_BASED_ON_ROAD_SPEED      = 15,
    USE_SHORT_CUT_LINKS                          = 16,
    CHANGE_LANES_AROUND_OBSTRUCTIONS             = 17,
    USE_SWITCHED_OFF_NODES                       = 18,
    PREFER_NAVMESH_ROUTE                         = 19,
    PLANE_TAXI_MODE                              = 20,
    FORCE_STRAIGHT_LINE                          = 21,
    USE_STRING_PULLING_AT_JUNCTIONS              = 22,
    TRY_TO_AVOID_HIGHWAYS                        = 23,
    FORCE_JOIN_IN_ROAD_DIRECTION                 = 24,
    STOP_AT_DESTINATION                          = 25,
}

-- `CVehicle::HandlingFlags`
---@enum eVehicleHandlingFlags
eVehicleHandlingFlags  = {
    SMOOTHED_COMPRESSION                      = 0,
    REDUCED_MOD_MASS                          = 1,
    HAS_KERS                                  = 2,
    HAS_RALLY_TYRES                           = 3,
    NO_HANDBRAKE                              = 4,
    STEER_REARWHEELS                          = 5,
    HANDBRAKE_REARWHEELSTEER                  = 6,
    STEER_ALL_WHEELS                          = 7,
    FREEWHEEL_NO_GAS                          = 8,
    NO_REVERSE                                = 9,
    REDUCED_RIGHTING_FORCE                    = 10,
    STEER_NO_WHEELS                           = 11,
    CVT                                       = 12,
    ...
    LESS_SNOW_SINK                            = 16,
    TYRES_CAN_CLIP                            = 17,
    REDUCED_DRIVE_OVER_DAMAGE                 = 18,
    ALT_EXT_WHEEL_BOUNDS_SHRINK               = 19,
    OFFROAD_ABILITIES                         = 20,
    OFFROAD_ABILITIES_X2                      = 21,
    TYRES_RAISE_SIDE_IMPACT_THRESHOLD         = 22,
    OFFROAD_INCREASED_GRAVITY_NO_FOLIAGE_DRAG = 23,
    ENABLE_LEAN                               = 24,
    FORCE_NO_TC_OR_SC                         = 25,
    HEAVYARMOUR                               = 26,
    ARMOURED                                  = 27,
    SELF_RIGHTING_IN_WATER                    = 28,
    IMPROVED_RIGHTING_FORCE                   = 29,
    LOW_SPEED_WHEELIES                        = 30,
}
...
eVehicleModelFlags     = {
    ...
    NO_EXHAUST                = 12,
    DOUBLE_EXHAUST            = 13,
    NO_1STPERSON_LOOKBEHIND   = 14,
    CAN_ENTER_IF_NO_DOOR      = 15,
    AXLE_F_TORSION            = 16,
    AXLE_F_SOLID              = 17,
    AXLE_F_MCPHERSON          = 18,
